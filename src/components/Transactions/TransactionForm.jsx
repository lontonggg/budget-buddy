...
export const TransactionForm = ({userId}) => {
    ...
    return (
        <div className='h-screen w-screen flex justify-center items-center'>
            <div className='bg-white w-[600px] min-w-[400px] rounded-2xl shadow-xl m-10'>
                <div className='flex justify-between items-center bg-indigo-500 p-5 rounded-t-xl text-xl text-white font-bold'>Create Transactions</div>
