...
export const Transactions = ({transaction}) => {
  ...
  return (
    <div className='flex rounded-xl justify-between items-center p-5 shadow-xl border-slate-300 border-2 hover:opacity-80 hover:scale-105 transition-transform duration-300'>
