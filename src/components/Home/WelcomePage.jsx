...
export const WelcomePage = () => {
  return (
    <div className='flex flex-col items-center justify-center h-screen w-screen bg-indigo-900'>
        <div className='flex flex-col gap-10 xs:gap-5 justify-center bg-white max-w-screen min-w-[400px] h-fit lg:p-20 md:p-16 sm:p-10 xs:p-8 rounded-3xl shadow-xl m-32'> 
